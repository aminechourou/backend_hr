...
public class EmailConstant {
    ...
    public static final String USERNAME = "chouroumohamedamine@gmail.com";
    public static final String PASSWORD = "nemxfeiehwaopvfj";
    public static final String FROM_EMAIL = "chouroumohamedamine@gmail.com";
